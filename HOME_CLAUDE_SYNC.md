...
#### 客戶點餐頁 (`customer-home`) — 首頁今日推薦卡（台灣分店）

| #   | 位置                 | 餐點         | 圖片路徑                 | 建議尺寸         | 格式 | 狀態      |
| --- | -------------------- | ------------ | ------------------------ | ---------------- | ---- | --------- |
| 1   | 首頁大卡（左側方圖） | 招牌滷肉飯   | `/assets/招牌滷肉飯.jpg` | **260 × 260 px** | JPG  | ✅ 已就位 |
| 2   | 首頁小卡（頂部橫幅） | 古早味排骨飯 | `/assets/古早味排骨.jpg` | **600 × 320 px** | JPG  | ✅ 已就位 |
| 3   | 首頁小卡（頂部橫幅） | 蚵仔麵線     | `/assets/蚵仔麵線.jpg`   | **600 × 320 px** | JPG  | ✅ 已就位 |

#### 客戶點餐頁 (`customer-home`) — 菜單商品卡（台灣分店）

顯示規格：width 100% of card × height 150 px，`background-size: cover`

| #   | 分類        | 餐點         | CSS class            | 建議尺寸         | 格式     |
| --- | ----------- | ------------ | -------------------- | ---------------- | -------- |
| 4   | 🔥 熱門精選 | 招牌滷肉飯   | `.mi-braised-pork`   | **500 × 300 px** | WebP/JPG |
| 5   | 🔥 熱門精選 | 古早味排骨飯 | `.mi-pork-chop`      | **500 × 300 px** | WebP/JPG |
| 6   | 🔥 熱門精選 | 蚵仔煎       | `.mi-oyster-pancake` | **500 × 300 px** | WebP/JPG |
| 7   | 🔥 熱門精選 | 控肉飯       | `.mi-braised-belly`  | **500 × 300 px** | WebP/JPG |
| 8   | 🧋 特調飲品 | 黑糖珍珠奶茶 | `.mi-bbt`            | **500 × 300 px** | WebP/JPG |
| 9   | 🧋 特調飲品 | 仙草奶茶     | `.mi-grass-jelly`    | **500 × 300 px** | WebP/JPG |

#### 客戶點餐頁 (`customer-home`) — 今日優惠卡（台灣分店）

顯示規格：卡片寬 240px × 圖示區高 140px，目前以深色漸層 + emoji 佔位，未來可換成食物實照

| #   | 優惠標籤 | 餐點         | 圖片路徑 | 原價   | 優惠價 | 格式 | 狀態      |
| --- | -------- | ------------ | -------- | ------ | ------ | ---- | --------- |
| 1   | 限時     | 阿三陽春麵   | `/assets/阿三陽春麵.jpg`   | NT$120 | NT$99  | JPG | ✅ 已就位 |
| 2   | 8折      | 蚵仔煎       | `/assets/蚵仔煎.jpg`       | NT$80  | NT$65  | JPG | ✅ 已就位 |
| 3   | 7折      | 黑糖珍珠奶茶 | `/assets/黑糖珍珠奶茶.jpg` | NT$75  | NT$55  | JPG | ✅ 已就位 |
| 4   | 限時     | 牛排         | `/assets/牛排.jpg`         | NT$130 | NT$105 | JPG | ✅ 已就位 |
| 5   | 今日     | 仙草奶茶     | `/assets/仙草奶茶.jpg`     | NT$65  | NT$49  | JPG | ✅ 已就位 |
| 6   | 9折      | 三杯雞       | `/assets/三杯雞.jpg`       | NT$150 | NT$135 | JPG | ✅ 已就位 |

#### POS 點餐頁 (`pos-terminal`) — 商品卡縮圖（台灣分店）

顯示規格：width 100% of card × height 80 px，`background-size: cover`

| #   | 餐點         | 英文名                  | 建議尺寸         | 格式     |
| --- | ------------ | ----------------------- | ---------------- | -------- |
| 10  | 招牌滷肉飯   | Braised Pork Rice       | **320 × 160 px** | WebP/JPG |
| 11  | 古早味排骨飯 | Pork Chop Rice          | **320 × 160 px** | WebP/JPG |
| 12  | 蚵仔煎       | Oyster Pancake          | **320 × 160 px** | WebP/JPG |
| 13  | 三杯雞       | Three-Cup Chicken Rice  | **320 × 160 px** | WebP/JPG |
| 14  | 控肉飯       | Braised Pork Belly Rice | **320 × 160 px** | WebP/JPG |
| 15  | 蚵仔麵線     | Oyster Vermicelli       | **320 × 160 px** | WebP/JPG |
| 16  | 黑糖珍珠奶茶 | Brown Sugar Boba        | **320 × 160 px** | WebP/JPG |
| 17  | 招牌滷蛋     | Marinated Egg           | **320 × 160 px** | WebP/JPG |
| 18  | 仙草奶茶     | Grass Jelly Milk Tea    | **320 × 160 px** | WebP/JPG |

> **合計：18 張**（台灣分店版）。滷肉飯、排骨飯、控肉飯建議拍高解析度原始照（≥ 1200 × 900 px）再裁切。
