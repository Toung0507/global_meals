...
- [x] POS 終端對比度提升與動畫優化
- [x] 客戶主頁「主廚推薦」三張卡片改用真實食物照片（招牌滷肉飯、古早味排骨飯、蚵仔麵線）
- [x] 客戶主頁首頁分類篩選改為飯食 / 麵食 / 小吃 / 輕食 / 飲品
- [x] 「探索風味」區塊全面改版為「今日優惠」橫向捲動卡片列（6 張，含劃線原價 + 特價標示）
- [x] 今日優惠 6 張卡片換用真實食物照片（阿三陽春麵、蚵仔煎、黑糖珍珠奶茶、牛排、仙草奶茶、三杯雞）

---

## 待辦事項

- [ ] 客戶主頁「菜單」頁籤商品卡以真實照片替換 CSS 漸層佔位符（6 張待上傳）
- [ ] POS 終端商品卡以真實照片替換 CSS 漸層佔位符（9 張待上傳）
